    ...
    return (
        <React.Fragment>
            ...
            <nav className={props.show ? 'Sidebar open' : 'Sidebar'}>
                ...
                <p>My name is Héctor and I’m a BA in English linguistics and literature. I worked as an English teacher for about 4 years but fell in love with web development in the end. Some of the tools I have learnt up until this points are HTML, CSS, JavaScript, Ruby, Ruby on Rails, PostgreSQL, Bootstrap, Sass, Git, and React among others. </p>
                <ul>
